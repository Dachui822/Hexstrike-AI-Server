...
DEFAULT_TOOLS = [
    ...
    {"name": "sqlmap", "display_name": "SQLMap", "category": "essential", "description": "Automatic SQL injection and database takeover tool.", "dependencies": {"pip": ["sqlmap"]}, "health_check_cmd": "sqlmap --version"},
    ...
    {"name": "autorecon", "display_name": "AutoRecon", "category": "network", "description": "Multi-threaded network reconnaissance tool.", "dependencies": {"pip": ["autorecon"]}, "health_check_cmd": "autorecon --help"},
    ...
    {"name": "nxc", "display_name": "NetExec", "category": "network", "description": "Network execution tool (formerly CrackMapExec).", "dependencies": {"pip": ["netexec"]}, "health_check_cmd": "nxc --version"},
    ...
    {"name": "dirsearch", "display_name": "Dirsearch", "category": "web_security", "description": "Web path scanner.", "dependencies": {"pip": ["dirsearch"]}, "health_check_cmd": "dirsearch -h"},
    {"name": "dotdotpwn", "display_name": "DotDotPwn", "category": "web_security", "description": "Directory traversal fuzzer.", "dependencies": {"pip": ["dotdotpwn"]}, "health_check_cmd": "dotdotpwn -h"},
    ...
    {"name": "wfuzz", "display_name": "WFuzz", "category": "web_security", "description": "Web application fuzzer.", "dependencies": {"pip": ["wfuzz"]}, "health_check_cmd": "wfuzz --version"},
    ...
    {"name": "arjun", "display_name": "Arjun", "category": "web_security", "description": "HTTP parameter discovery tool.", "dependencies": {"pip": ["arjun"]}, "health_check_cmd": "arjun --help"},
    {"name": "paramspider", "display_name": "ParamSpider", "category": "web_security", "description": "Parameter discovery tool.", "dependencies": {"pip": ["paramspider"]}, "health_check_cmd": "paramspider --help"},
    ...
    {"name": "wafw00f", "display_name": "WAFW00F", "category": "web_security", "description": "Web Application Firewall detection.", "dependencies": {"pip": ["wafw00f"]}, "health_check_cmd": "wafw00f --version"},
    ...
    {"name": "patator", "display_name": "Patator", "category": "password", "description": "Multi-purpose brute forcer.", "dependencies": {"pip": ["patator"]}, "health_check_cmd": "patator -h"},
    ...
    {"name": "ropgadget", "display_name": "ROPgadget", "category": "binary", "description": "ROP chain generator.", "dependencies": {"pip": ["ropgadget"]}, "health_check_cmd": "ROPgadget --version"},
    ...
    {"name": "one-gadget", "display_name": "One-Gadget", "category": "binary", "description": "glibc RCE gadget finder.", "dependencies": {"pip": ["one-gadget"]}, "health_check_cmd": "one-gadget --version"},
    {"name": "ropper", "display_name": "Ropper", "category": "binary", "description": "ROP gadget finder.", "dependencies": {"pip": ["ropper"]}, "health_check_cmd": "ropper --version"},
    {"name": "angr", "display_name": "Angr", "category": "binary", "description": "Binary analysis framework.", "dependencies": {"pip": ["angr"]}, "health_check_cmd": "python3 -c 'import angr; print(angr.__version__)'"},
    ...
    {"name": "pwninit", "display_name": "Pwninit", "category": "binary", "description": "Automate starting binary exploitation.", "dependencies": {"pip": ["pwninit"]}, "health_check_cmd": "pwninit --help"},

    # === Forensics Tools ===
    {"name": "volatility3", "display_name": "Volatility 3", "category": "forensics", "description": "Memory forensics framework.", "dependencies": {"pip": ["volatility3"]}, "health_check_cmd": "volatility3 --help"},
    {"name": "vol", "display_name": "Vol (Volatility 2)", "category": "forensics", "description": "Volatility 2 memory forensics.", "dependencies": {"pip": ["volatility"]}, "health_check_cmd": "vol.py --help"},
    ...
    {"name": "prowler", "display_name": "Prowler", "category": "cloud", "description": "AWS security assessment.", "dependencies": {"pip": ["prowler"]}, "health_check_cmd": "prowler --version"},
    {"name": "scout-suite", "display_name": "Scout Suite", "category": "cloud", "description": "Multi-cloud security audit.", "dependencies": {"pip": ["scoutsuite"]}, "health_check_cmd": "scout --version"},
    ...
    {"name": "kube-hunter", "display_name": "Kube-Hunter", "category": "cloud", "description": "Kubernetes security scanner.", "dependencies": {"pip": ["kube-hunter"]}, "health_check_cmd": "kube-hunter --list"},
    ...
    {"name": "checkov", "display_name": "Checkov", "category": "cloud", "description": "Infrastructure as Code scanner.", "dependencies": {"pip": ["checkov"]}, "health_check_cmd": "checkov --version"},
    ...
    {"name": "theharvester", "display_name": "theHarvester", "category": "osint", "description": "Email/subdomain/IP harvester.", "dependencies": {"pip": ["theharvester"]}, "health_check_cmd": "theharvester -h"},
    {"name": "sherlock", "display_name": "Sherlock", "category": "osint", "description": "Social media username search.", "dependencies": {"pip": ["sherlock"]}, "health_check_cmd": "sherlock --help"},
    {"name": "social-analyzer", "display_name": "Social Analyzer", "category": "osint", "description": "Social media analysis.", "dependencies": {"pip": ["social-analyzer"]}, "health_check_cmd": "social-analyzer --help"},
    {"name": "recon-ng", "display_name": "Recon-ng", "category": "osint", "description": "Web-based reconnaissance.", "dependencies": {"pip": ["recon-ng"]}, "health_check_cmd": "recon-ng --version"},
    ...
    {"name": "spiderfoot", "display_name": "SpiderFoot", "category": "osint", "description": "Automated OSINT.", "dependencies": {"pip": ["spiderfoot"]}, "health_check_cmd": "spiderfoot --help"},
    {"name": "shodan", "display_name": "Shodan", "category": "osint", "description": "Internet-wide scanner CLI.", "dependencies": {"pip": ["shodan"]}, "health_check_cmd": "shodan --version"},
    {"name": "censys-cli", "display_name": "Censys CLI", "category": "osint", "description": "Internet search engine CLI.", "dependencies": {"pip": ["censys"]}, "health_check_cmd": "censys --version"},
    {"name": "have-i-been-pwned", "display_name": "Have I Been Pwned", "category": "osint", "description": "Breach checking tool.", "dependencies": {"pip": ["hibp"]}, "health_check_cmd": "hibp --help"},
    ...
    # === API Tools ===
    {"name": "api-schema-analyzer", "display_name": "API Schema Analyzer", "category": "api", "description": "API schema security analyzer.", "dependencies": {"pip": ["api-schema-analyzer"]}, "health_check_cmd": "api-schema-analyzer --help"},
    {"name": "curl", "display_name": "cURL", "category": "api", "description": "HTTP client.", "dependencies": {"apt": ["curl"]}, "health_check_cmd": "curl --version"},
    {"name": "httpie", "display_name": "HTTPie", "category": "api", "description": "Modern HTTP client.", "dependencies": {"pip": ["httpie"]}, "health_check_cmd": "http --version"},
    ...
    {"name": "uro", "display_name": "Uro", "category": "api", "description": "URL optimization tool.", "dependencies": {"pip": ["uro"]}, "health_check_cmd": "uro --help"},
    ...
    # === Additional Tools ===
    {"name": "smbmap", "display_name": "SMBMap", "category": "additional", "description": "SMB share enumerator.", "dependencies": {"pip": ["smbmap"]}, "health_check_cmd": "smbmap --help"},
    {"name": "volatility", "display_name": "Volatility 2", "category": "additional", "description": "Memory forensics (v2).", "dependencies": {"pip": ["volatility"]}, "health_check_cmd": "vol.py --help"},
    ...
    {"name": "evil-winrm", "display_name": "Evil-WinRM", "category": "additional", "description": "WinRM shell.", "dependencies": {"pip": ["evil-winrm"]}, "health_check_cmd": "evil-winrm --help"},
    ...
    {"name": "pwntools", "display_name": "Pwntools", "category": "additional", "description": "CTF framework.", "dependencies": {"pip": ["pwntools"]}, "health_check_cmd": "python3 -c 'import pwn; print(pwn.__version__)'"},
    {"name": "jwt-analyzer", "display_name": "JWT Analyzer", "category": "additional", "description": "JWT token analyzer.", "dependencies": {"pip": ["jwt"]}, "health_check_cmd": "python3 -c 'import jwt; print(jwt.__version__)'"},
    {"name": "graphql-scanner", "display_name": "GraphQL Scanner", "category": "additional", "description": "GraphQL security scanner.", "dependencies": {"pip": ["graphql-scanner"]}, "health_check_cmd": "graphql-scanner --help"},
]
